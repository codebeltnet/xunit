...
/// <summary>
/// Provides an entrypoint-owned implementation of the <see cref="IApplicationFixture{TEntryPoint}"/> interface.
/// </summary>
...
/// <remarks>
/// The application's <c>Main</c> method owns host startup. The fixture captures the host after it has been built without starting it during fixture setup; the test host starts the deferred host when it is consumed.
/// </remarks>
